...
class CalculatorImpl(calculator: Calculator, val context: Context) {
    ...
    fun numpadClicked(id: Int) {
        ...
        when (id) {
            R.id.tvDecimal -> decimalClicked()
            R.id.tvZero -> zeroClicked()
            R.id.tvOne -> addDigit(1)
            R.id.tvTwo -> addDigit(2)
            R.id.tvThree -> addDigit(3)
            R.id.tvFour -> addDigit(4)
            R.id.tvFive -> addDigit(5)
            R.id.tvSix -> addDigit(6)
            R.id.tvSeven -> addDigit(7)
            R.id.tvEight -> addDigit(8)
            R.id.tvNine -> addDigit(9)
        }
    }
}
