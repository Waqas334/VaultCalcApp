package com.androidbull.calculator.photo.vault.model;
...
public class AllAudioModel implements Parcelable {
    ...
    static class C06151 implements Creator<AllAudioModel> {
        ...
        public AllAudioModel createFromParcel(Parcel source) {
            return new AllAudioModel(source);
        }

        public AllAudioModel[] newArray(int size) {
            return new AllAudioModel[size];
        }
    }

    public AllAudioModel(String imagePath, long imageLastModified) {
        this.oldPath = imagePath;
        this.lastModified = imageLastModified;
    }

    public AllAudioModel(String imagePath, String newPath) {
        this.oldPath = imagePath;
        this.newPath = newPath;
    }

    public AllAudioModel(int imageId, String imagePath, String newPath) {
    ...
    protected AllAudioModel(Parcel in) {
        boolean z = false;
